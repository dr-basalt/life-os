...
const GATES = [
  ...
  { name: 'coolify-api',      type: 'api',    role: 'compute',          source_path: 'https://app.coolify.io',                       parser: 'json', targets: [], auth_mode: 'bearer', auth_secret_ref: 'COOLIFY_API_TOKEN', description: 'Coolify — PaaS déployant SternOS sur stern-os-brain 46.224.111.203' },
  // ── Storage ───────────────────────────────────────────────────────────────
